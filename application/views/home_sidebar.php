...
<html>
    <head>
        ...
        <script src="http://localhost/SA4semestre/assets/js/init.js"></script>
        <noscript>
        <link rel="stylesheet" href="http://localhost/SA4semestre/assets/css/skel.css" />
        <link rel="stylesheet" href="http://localhost/SA4semestre/assets/css/style.css" />
        <link rel="stylesheet" href="http://localhost/SA4semestre/assets/css/style-desktop.css" />
        <link rel="stylesheet" href="http://localhost/SA4semestre/assets/css/style-wide.css" />
        </noscript>
