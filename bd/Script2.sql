...
START TRANSACTION;
USE `sitap`;
INSERT INTO `sitap`.`tbl_usuario` (`idtbl_usuario`, `nome`, `senha`, `email`, `foto`, `sexo`, `cidade`, `estado`, `endereco`, `cep`) VALUES (2, 'Gilverson', '1234', 'gilverson@gmail.com', 'http://lorempixel.com/output/people-q-c-300-300-3.jpg', 'M', 'Brunopolis', 'Bumbameuboi', 'Xablau', '88657-987');
INSERT INTO `sitap`.`tbl_usuario` (`idtbl_usuario`, `nome`, `senha`, `email`, `foto`, `sexo`, `cidade`, `estado`, `endereco`, `cep`) VALUES (0, 'Anonimo', NULL, 'anonimo@anonimo.com', NULL, '', 'anonimo', 'anonimo', 'anonimo', '88888888');
INSERT INTO `sitap`.`tbl_usuario` (`idtbl_usuario`, `nome`, `senha`, `email`, `foto`, `sexo`, `cidade`, `estado`, `endereco`, `cep`) VALUES (1, 'Admin ', 'admin@admin.com', '1234', NULL, NULL, 'admin', 'admin', 'admin', '99999999');
INSERT INTO `sitap`.`tbl_usuario` (`idtbl_usuario`, `nome`, `senha`, `email`, `foto`, `sexo`, `cidade`, `estado`, `endereco`, `cep`) VALUES (3, 'Cacila', '1234', 'cacilda@cacilda.com', 'http://lorempixel.com/output/people-q-c-300-300-9.jpg', 'F', 'Gubiruba', 'SC', 'Cacilda', '987456-584');
